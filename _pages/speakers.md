...
title: speakers
permalink: /speakers/
description: Speakers for IICCSSS 2026 are researchers from diverse subfields of computational cognitive science.
nav: true
nav_order: 4
---
...
<div class="container">
    ...
    {% include people.liquid
        ...
        img="assets/img/speakers/2026/faustoCarcassi.png"
    %}
    {% include people.liquid
    ...
    {% include people.liquid
        ...
        img="assets/img/speakers/2026/hongYuWong.jpg"
    %}
    </div>
</div>
